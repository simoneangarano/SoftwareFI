...
class CifarDataModule(pytorch_lightning.LightningDataModule):
    def __init__(self, dataset='cifar10', data_dir='data', batch_size=128, num_gpus=1, augs={}):
        ...
        self.size = 32 if self.dataset != 'ImageNet' else 256
    ...
    def setup(self, stage=None):
        ...
        self.test_trans = transforms.Compose(
            [transforms.Resize((self.size, self.size)), transforms.ToTensor(), normalize])
    ...
    def train_dataloader(self):
        return get_loader(self.train_data, self.batch_size // self.num_gpus, 4 * self.num_gpus, self.n_classes,
                          ...
                          rand_aug=self.rand_aug, label_smooth=self.label_smooth, size=self.size)
